...
import { inserirNovoGrupo } from '../Funcoes';

export default class NovoGrupo extends React.Component {
	constructor(props) {
		super(props)
			...
			<View style={styles.container}>
				<View style={styles.containerBack}>
					...
					<View style={styles.innerContainer}>
						...
						<TouchableOpacity 
							style={styles.button}
							onPress={() => inserirNovoGrupo(this.state.grupo, this.state.organizacao, this.props.navigation)}
						>
